...
import { View, TextInput, Button, SafeAreaView, ScrollView, Text, Switch, TouchableOpacity, Image } from 'react-native'
  ...
  const onSignUp = () => {
    ...
    return (
      ...
      <LinearGradient style={{alignSelf: "center", marginTop: 30, width: "80%", marginBottom: 50, borderRadius: 35}} start={{x: 0, y: 0 }} end={{x: 1, y: 1}} colors={['#30a4fc', '#2084c4']}>
        <TouchableOpacity style={{padding: 10,}}><Text style={{color: "#fff", textAlign: "center"}} onPress={() => onSignUp()}>Registar</Text></TouchableOpacity>
      </LinearGradient>
      </ScrollView>
    </View>
    )
