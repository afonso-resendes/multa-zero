...
=======
import { View, Text, Button, ScrollView, Image, TouchableOpacity, TextInput } from 'react-native'
      ...
      return (
        <SafeAreaView style={{backgroundColor: "#fff", flex: 1}}>
          ...
          />
            ...
            <TouchableOpacity style={{padding: 10,}}><Text style={{color: "#fff", textAlign: "center"}} 
              onPress={() => this.onSignIn()}>Entrar</Text></TouchableOpacity>
          </LinearGradient>
          ...
          <View style={{borderWidth: 0.5, borderColor: "#e8e8e9", marginTop: 10, zIndex: -1}}></View>
            <TouchableOpacity style={{bottom: 75, position: "absolute", alignContent: "center", width: "100%"}} onPress={() => props.navigation.navigate("Register")}><Text style={{color: "#000", textAlign: "center", fontSize: 13}}>Ainda não tem conta?</Text></TouchableOpacity>
            <TouchableOpacity style={{bottom: 50, position: "absolute", alignContent: "center", width: "100%"}} onPress={() => props.navigation.navigate("Register")}><Text style={{color: "#30a4fc", textAlign: "center"}}>Criar uma nova conta</Text></TouchableOpacity>
        </SafeAreaView>
      )
...
=======
  return (
    <View style={{backgroundColor: "#fff", flex: 1}}>
      <Image style={{width: 180, height: 50, alignSelf: "center", borderColor: "#8c8c8c", borderWidth: 0.5, marginTop: 60}} source={require("../.././imgs/logo.psd")} />
        
      <TextInput
        style={{backgroundColor: "transparent", marginTop: "20%", marginLeft: 25, marginRight: 25, marginBottom: 15, paddingBottom: 10, borderBottomColor: "#e8e8e9", borderBottomWidth: 1}}
        placeholder="Email"
        placeholderTextColor="#8c8c8c"
        keyboardType="twitter"
      />
    ...
    <View style={{bottom: 60, width: "100%"}}><Text style={{color: "#000", textAlign: "center", fontSize: 13}}>Ainda não tem conta?</Text></View>
    <TouchableOpacity style={{bottom: 50, width: "100%"}} onPress={() => navigation.navigate("Criar Conta")}><Text style={{color: "#30a4fc", textAlign: "center"}}>Criar uma nova conta</Text></TouchableOpacity>
    </View>
    </View>
